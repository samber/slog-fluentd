...
type Converter func(tag string, loggerAttr []slog.Attr, record *slog.Record) map[string]any

func DefaultConverter(tag string, loggerAttr []slog.Attr, record *slog.Record) map[string]any {
	log := map[string]any{
